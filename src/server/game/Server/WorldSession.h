...
namespace WorldPackets
{
    ...
    namespace Housing
    {
		...
		class DecorRemove;
		class DecorLock;
		class DecorRequestStorage;
		class FixtureSetCoreFixture;
		class FixtureSetHouseSize;
		class FixtureSetHouseType;
		class FixtureCreateFixture;
		class FixtureDeleteFixture;
		class RoomAdd;
		class RoomRemove;
		class RoomMove;
		class RoomRotate;
		class RoomSetCeilingType;
		class RoomSetDoorType;
		class RoomSetComponentTheme;
    }
...
class TC_GAME_API WorldSession
{
    ...
    public:                                                 // opcodes handlers
        ...
        void HandleHousingDecorPlace(WorldPackets::Housing::DecorPlace const& packet);
        void HandleHousingDecorMove(WorldPackets::Housing::DecorMove const& packet);
        void HandleHousingDecorRemove(WorldPackets::Housing::DecorRemove const& packet);
        void HandleHousingDecorLock(WorldPackets::Housing::DecorLock const& packet);
        void HandleHousingDecorRequestStorage(WorldPackets::Housing::DecorRequestStorage const& packet);
        void HandleHousingFixtureSetCoreFixture(WorldPackets::Housing::FixtureSetCoreFixture const& packet);
        void HandleHousingFixtureSetHouseSize(WorldPackets::Housing::FixtureSetHouseSize const& packet);
        void HandleHousingFixtureSetHouseType(WorldPackets::Housing::FixtureSetHouseType const& packet);
        void HandleHousingFixtureCreateFixture(WorldPackets::Housing::FixtureCreateFixture const& packet);
        void HandleHousingFixtureDeleteFixture(WorldPackets::Housing::FixtureDeleteFixture const& packet);
        void HandleHousingRoomAdd(WorldPackets::Housing::RoomAdd const& packet);
        void HandleHousingRoomRemove(WorldPackets::Housing::RoomRemove const& packet);
        void HandleHousingRoomMove(WorldPackets::Housing::RoomMove const& packet);
        void HandleHousingRoomRotate(WorldPackets::Housing::RoomRotate const& packet);
        void HandleHousingRoomSetCeilingType(WorldPackets::Housing::RoomSetCeilingType const& packet);
        void HandleHousingRoomSetDoorType(WorldPackets::Housing::RoomSetDoorType const& packet);
        void HandleHousingRoomSetComponentTheme(WorldPackets::Housing::RoomSetComponentTheme const& packet);
		void HandleHousingDashboardRequest(WorldPackets::Null& packet);
		void HandleNeighborhoodBuyHouse(WorldPackets::Null& packet);
        void HandleHousingSvcsStartTutorial(WorldPackets::Housing::SvcsStartTutorial& packet);
        void HandleHousingSellHouse(WorldPackets::Null& /*packet*/);
        void HandleHousingTeleportToOwnedPlot(WorldPackets::Null& /*packet*/);
        void HandleHousingRequestStorage(WorldPackets::Null& /*packet*/);
        void HandleHousingDecorMutation(WorldPackets::Null& /*packet*/);
        void HandleHousingInviteVisitor(WorldPackets::Null& /*packet*/);
        void HandleHousingPermissionsRequest(WorldPackets::Null& /*packet*/);
		...
		void HandleOpenTradeskillNpc(WorldPackets::TradeSkill::OpenTradeskillNpc& packet);
		void HandlePerksProgramStatusRequest(WorldPackets::Perks::PerksProgramStatusRequest& packet);
