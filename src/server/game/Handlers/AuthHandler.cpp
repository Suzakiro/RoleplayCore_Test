...
void WorldSession::SendFeatureSystemStatusGlueScreen()
{
    ...
    features.BpayStoreAvailable = sWorld->getBoolConfig(CONFIG_BPAY_STORE_ENABLED);
	...
	auto const getMirrorVarBool = [](WorldBoolConfigs config) -> std::string_view
    {
        return sWorld->getBoolConfig(config) ? "1"sv : "0"sv;
    };
    ...
    WorldPackets::System::MirrorVarSingle vars[] =
    {
        ...
        { "shop2Enabled"sv, getMirrorVarBool(CONFIG_BPAY_STORE_MICRO_MENU_ENABLED) },
        { "bpayStoreEnable"sv, getMirrorVarBool(CONFIG_BPAY_STORE_ENABLED) },
        { "recentAlliesEnabledClient"sv, "0"sv },
        { "browserEnabled"sv, "0"sv },
        { "housingEnableCreateGuildNeighborhood"sv, getMirrorVarBool(CONFIG_HOUSING_ENABLE_CREATE_GUILD_NEIGHBORHOOD) },
        { "housingEnableDeleteHouse"sv, getMirrorVarBool(CONFIG_HOUSING_ENABLE_DELETE_HOUSE) },
        { "housingServiceEnabled"sv, getMirrorVarBool(CONFIG_HOUSING_ENABLED) },
        { "housingEnableMoveHouse"sv, getMirrorVarBool(CONFIG_HOUSING_ENABLE_MOVE_HOUSE) },
        { "housingEnableCreateCharterNeighborhood"sv, getMirrorVarBool(CONFIG_HOUSING_ENABLE_CREATE_CHARTER_NEIGHBORHOOD) },
        { "housingEnableBuyHouse"sv, getMirrorVarBool(CONFIG_HOUSING_ENABLE_BUY_HOUSE) },
        { "housingMarketEnabled"sv, getMirrorVarBool(CONFIG_HOUSING_MARKET_ENABLED) },
    };
