...
void World::LoadConfigSettings(bool reload)
{
    ...
    { {
        ...
        { .Name = "Housing.EnableCreateGuildNeighborhood"sv, .DefaultValue = false, .Index = CONFIG_HOUSING_ENABLE_CREATE_GUILD_NEIGHBORHOOD },
        { .Name = "Housing.EnableDeleteHouse"sv, .DefaultValue = false, .Index = CONFIG_HOUSING_ENABLE_DELETE_HOUSE },
        { .Name = "Housing.EnableMoveHouse"sv, .DefaultValue = false, .Index = CONFIG_HOUSING_ENABLE_MOVE_HOUSE },
        { .Name = "Housing.EnableCreateCharterNeighborhood"sv, .DefaultValue = false, .Index = CONFIG_HOUSING_ENABLE_CREATE_CHARTER_NEIGHBORHOOD },
        { .Name = "Housing.EnableBuyHouse"sv, .DefaultValue = false, .Index = CONFIG_HOUSING_ENABLE_BUY_HOUSE },
        { .Name = "Housing.MarketEnabled"sv, .DefaultValue = false, .Index = CONFIG_HOUSING_MARKET_ENABLED },
		{ .Name = "BattlePay.Store.Enabled"sv, .DefaultValue = true, .Index = CONFIG_BPAY_STORE_ENABLED },
        { .Name = "BattlePay.Store.MicroMenuButton.Enabled"sv, .DefaultValue = true, .Index = CONFIG_BPAY_STORE_MICRO_MENU_ENABLED },
